...
class GlobalNet(nn.Module):
    def __init__(self, config, block, num_blocks, pretrained_model=None):
        ...
        # Lateral layers
        self.latlayer1 = nn.Sequential(nn.Dropout2d(0.5),
                                       nn.Conv2d(2048, 256, kernel_size=1, stride=1, padding=0))
        self.latlayer2 = nn.Sequential(nn.Dropout2d(0.5),
                                       nn.Conv2d(1024, 256, kernel_size=1, stride=1, padding=0))
        self.latlayer3 = nn.Sequential(nn.Dropout2d(0.5),
                                       nn.Conv2d(512, 256, kernel_size=1, stride=1, padding=0))
        self.latlayer4 = nn.Sequential(nn.Dropout2d(0.5),
...
class RefineNet(nn.Module):
    def __init__(self, config):
        ...
        self.output = nn.Sequential(nn.Dropout2d(0.5),
                                    Bottleneck(1024, 64, 1),
