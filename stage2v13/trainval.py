...
from stage2v13.data_generator import DataGenerator
from stage2v13.cascade_pyramid_network_v13 import CascadePyramidNetV13
from stage2v13.viserrloss_v13 import VisErrorLossV13
...
def train(data_loader, net, loss, optimizer, lr):
    ...
    for i, (data, heatmaps, vismaps) in enumerate(data_loader):
        ...
        optimizer.step()
        metrics.append([loss_output[0].data[0], loss_output[1].data[0], loss_output[2].data[0]])
...
if __name__ == '__main__':
    ...
    log_mode = 'w'
    if resume:
        checkpoint = torch.load(save_dir + 'kpt_outwear_038.ckpt')
