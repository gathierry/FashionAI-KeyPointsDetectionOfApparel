...
from stage2v2.data_generator import DataGenerator
from stage2v2.cascade_pyramid_network_v2 import CascadePyramidNetV2
from stage2v2.viserrloss_v2 import VisErrorLossV2
...
def train(data_loader, net, loss, optimizer, lr):
    ...
    for i, (data, heatmaps, vismaps) in enumerate(data_loader):
        ...
        heatmaps = [Variable(h.cuda(async=True)) for h in heatmaps]
